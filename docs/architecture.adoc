...
and embedded as rendered SVGs. Regenerate after editing with
...
image::diagrams/system-overview.svg[System overview block diagram]
...
image::diagrams/power-fsm.svg[Power-mode state machine]
...
image::diagrams/probe-flow.svg[Probe / initialization flow]
...
image::diagrams/raw-read-seq.svg[On-demand raw read sequence]
...
image::diagrams/event-flow-seq.svg[Threshold event delivery sequence]
...
image::diagrams/buffer-flow-seq.svg[Triggered buffer capture sequence]
