...
| `in_illuminance_integration_time` (+`_available`) | CFG[2:1] | One of `0.05 0.1 0.2 0.4` s; when the CALIB_ALS_TIME override is set, writes return `-EOPNOTSUPP` and `_available` lists only the calibrated time
