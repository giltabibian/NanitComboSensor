...
The 11 tests run one at a time (never concurrently); the exit code is 0 only
...
[7/11] triggered-buffer             FAIL: median sample spacing 612 ms, expected ~200 ms
----
