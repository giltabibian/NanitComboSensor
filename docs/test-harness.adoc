...
The 10 tests run sequentially; configuration tests restore the defaults they
...
[6/10] triggered-buffer             FAIL: median sample spacing 612 ms, expected ~200 ms
----
